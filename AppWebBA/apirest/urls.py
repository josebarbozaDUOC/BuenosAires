...
from .views import producto_update, producto_delete, login, obtener_equipos_en_bodega, obtener_productos, verificar_password, obtener_equipos_anwo, obtener_guias_de_despacho, reservar_equipo_anwo, estado_despachado_guia_de_despacho, estado_entregado_guia_de_despacho, obtener_stock, obtener_facturas, validar_login_escritorio
...
urlpatterns = [
    ...
    path('estado_despachado_guia_de_despacho/<nro>', estado_despachado_guia_de_despacho, name='estado_despachado_guia_de_despacho'),
    path('estado_entregado_guia_de_despacho/<nro>', estado_entregado_guia_de_despacho, name='estado_entregado_guia_de_despacho'),
