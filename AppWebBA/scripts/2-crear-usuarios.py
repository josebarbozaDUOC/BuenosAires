...
def run():
    ...
    if not User.objects.filter(username='creyes').exists():    User.objects.create_user(password='123', username='creyes',    first_name='Carlos', last_name='Reyes',  email='creyes@duoc.cl',  is_staff=True)
